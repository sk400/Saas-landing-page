...
const Turbo: NextPage = () => {
  return (
    <div className="flex-1 rounded-mini flex flex-col items-center justify-center  gap-[55px] ml-[auto] mr-[auto] text-center text-mini text-black font-inter border-[2px] border-solid border-coral xs:ml-[auto] xs:mr-[auto] xs:flex-[unset] xs:self-stretch md:flex-[unset] md:self-stretch lg:flex-[unset] lg:self-stretch xl:flex-[unset] xl:self-stretch py-[50px] px-[15px] hover:scale-105 transition duration-200 cursor-pointer">
      <h1 className="m-0 relative text-10xl leading-[33px] font-bold font-inherit text-gray-200">
        Turbo
      </h1>
      ...
      <div className="self-stretch flex flex-col items-center justify-center gap-[20px]">
        ...
        <div className="self-stretch flex flex-col items-center justify-center pt-0 pb-[50px] pr-[49.65625px] pl-[27px] gap-[10px] text-sm">
          <div className="self-stretch relative leading-[20px]">
            UI execution
          </div>
      ...
      <button className="self-stretch   rounded-mini flex flex-row items-center justify-center py-[23px]  gap-[7.44px] text-left text-sm border-[2px] border-solid border-black hover:scale-105 transition duration-200">
